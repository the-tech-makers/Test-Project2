<?php
require_once ('common/header_login.php');
?>
    ...
    <div class="card-body register-card-body">
      ...
      <form action="<?php echo base_url();?>/register" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" name="register_user">Register</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<?php
require_once ('common/footer_login.php');
?>
