        ...
        <form method="post" action="main_function.php">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="card card-secondary">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label for="inputSpentBudget">Total amount</label>
				...
				<div class="col-12">
					...
					<input class="btn btn-success float-right" type="submit" name="edit_project" value="Save Change">
				</div>
